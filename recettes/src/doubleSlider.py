...
from PyQt5.QtWidgets import (QWidget, QHBoxLayout, QVBoxLayout,
                             QPushButton, QApplication, QDoubleSpinBox,QComboBox)
...
class InputQuantite(QWidget):
    def __init__(self,wind,l=["","a","b"],tabConv=None):
        ...
        self.maxi=QDoubleSpinBox(maximum=float("inf"), prefix="Maximum : ",suffix=" "+self.u)
    ...
    def save(self,wind):
        if self.u!="":
            ...
            wind.amount=(self.convert(self.mini.value()),self.convert(self.maxi.value()))
        else:
